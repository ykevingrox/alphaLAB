...
from biotech_alpha.technical_features import technical_feature_payload_from_csv


def technical_timing_from_ohlcv(
    path: str | Path,
    *,
    ...
    return technical_feature_payload_from_csv(
        path,
        symbol=symbol,
        provider=provider,
